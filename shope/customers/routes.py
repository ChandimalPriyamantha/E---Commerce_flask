...
from shope.__int__ import db, app,photos,search, bcrypt, login_manager
...
def get_pdf(invoice):
    if current_user.is_authenticated:
        ...
        if request.method=="POST":
            ...
            rendered=render_template('customer/order.html', invoice=invoice, tax=tax,  grandTotal=grandTotal, customer=customer, orders=orders)
